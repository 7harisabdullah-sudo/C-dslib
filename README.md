...
9) **INITIAL_CAPACITY** is library defined rather that being user defined and that is because **INITIAL_CAPACITY** is cleaner being a power of 2 i.e. **INITIAL CAPACITY = 2^k, k >= 1** because that way it grows to be a power of 2 and it shrinks to be a power of 2 and that symmetry is really very comfortable while reasoning about the growth and shrinking system.
